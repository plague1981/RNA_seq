...
if (s_species=='Human'){
  ...
  if (!check.packages('org.Mm.eg.db')){BiocManager::install("org.Mm.eg.db")}
...
if (overall_answer=="y"|overall_answer=="yes"){
  ...
  print("total.genes.rpkm.table.xlsx was created")
  write.xlsx(total.cpm.table, "total.genes.cpm.table.xlsx")
  print("total.genes.cmp.table.xlsx was created")
} else if (overall_answer=="n"|overall_answer=="no"){
  print("No files was created")
}
