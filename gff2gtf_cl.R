...
parser$add_usage('gff2gtf.R [options]')
parser$add_description('An executable R script parsing arguments from Unix-like command line. It converts a gff file to gtf file')
...
parser$add_argument('--f', type = 'character', help = '"filename",Enter your *.gff filename')
parser$helpme()
# === variables ====
dirPath <- dir
